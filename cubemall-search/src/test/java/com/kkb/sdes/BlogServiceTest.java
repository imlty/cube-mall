...
import com.kkb.cubemall.search.service.BlogManageService;
...
public class BlogServiceTest {
    ...
    public void crateIndex() {
        blogManageService.crateIndex();
    }

    @Test
    public void putMapping() {
        blogManageService.putMapping();
    }

    @Test
    public void deleteIndex() {
        blogManageService.deleteIndex("blog*");
    }

    @Test
    public void getDocumentById() {
        Blog blog = blogManageService.getDocumentById("1");
        System.out.println(blog);
    }

    @Test
    public void bulkBlog() {
        JSONArray jsonArray = JSONObject.parseArray("[{\"id\":1, \"title\":\"帮日本核废水“出招”？知名男艺人迷之操作让人看呆了..\", \"content\":\"帮日本核废水“出招”？知名男艺人迷之操作让人看呆了..\", \"comment\":\"娱乐\", \"mobile\":\"13900112233\"}\n" +
                ...
                "]");
        List<Blog> blogList = jsonArray.stream()
                .map(item -> {
                    JSONObject json = (JSONObject) item;
                    Blog blog = json.toJavaObject(Blog.class);
                    return blog;
                })
                .collect(Collectors.toList());
        R result = blogManageService.bulkBlog(blogList);
