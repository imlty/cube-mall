<template>
  <el-dialog
    ...
    <el-form-item label="图片名称" prop="imgName">
      <el-input v-model="dataForm.imgName" placeholder="图片名称"></el-input>
    </el-form-item>
    <el-form-item label="图片url" prop="imgUrl">
      <el-input v-model="dataForm.imgUrl" placeholder="图片url"></el-input>
    </el-form-item>
    <el-form-item label="图片顺序" prop="imgSort">
      <el-input v-model="dataForm.imgSort" placeholder="图片顺序"></el-input>
    </el-form-item>
    <el-form-item label="默认图片" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="默认图片"></el-input>
    </el-form-item>
    </el-form>
