<template>
  <el-dialog
    ...
    <el-form-item label="属性排序" prop="attrSort">
      <el-input v-model="dataForm.attrSort" placeholder="属性排序"></el-input>
    </el-form-item>
    <el-form-item label="显示" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="显示"></el-input>
    </el-form-item>
    </el-form>
